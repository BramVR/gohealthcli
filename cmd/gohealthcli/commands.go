...
var commands = []commandDef{
	...
	},
	{
		...
		PositionalArgs:       "<list|scopes|verify>",
		PositionalCompletion: valueCompletionCatalogAction,
		Flags: withCommonSubset(catalogCommonFlagNames(),
			flagSpec{Name: "discovery", Type: "string", Default: "", Usage: "with verify: read a Google Health discovery document from PATH instead of the public endpoint", ValueCompletion: valueCompletionFile},
		),
